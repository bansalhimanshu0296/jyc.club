...
<div class="table_full">
    <div class="table">
        <input type="text" name="val[host]" id="host" value="{value type='input' id='host'}" placeholder="Database Host" size="30" />
    </div>
    <div class="table">
        <input type="text" name="val[name]" id="name" value="{value type='input' id='name'}" placeholder="Database Name" size="30" />
    </div>
    <div class="table">
        <input type="text" name="val[user_name]" id="user_name" value="{value type='input' id='user_name'}" placeholder="Database User Name" size="30" />
    </div>
    <div class="table">
        <input type="password" name="val[password]" id="password" value="{value type='input' id='password'}" placeholder="Database Password" size="30" />
    </div>
    <div class="table">
        <input type="text" name="val[port]" id="port" value="{value type='input' id='port'}" placeholder="Database Port (optional)" size="30" />
    </div>
    <div class="table">
        <input type="text" name="val[prefix]" id="prefix" value="{value type='input' id='prefix' default='phpfox_'}" placeholder="Table Prefix" size="30" />
    </div>
</div>
