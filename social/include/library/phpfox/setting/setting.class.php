...
class Phpfox_Setting
{
	...
	public function __construct()
	{
		...
		if (!defined('PHPFOX_INSTALLER') && !file_exists(PHPFOX_DIR_SERVER_SETTING . 'server.sett.php') && file_exists(PHPFOX_DIR . 'install' . PHPFOX_DS . 'index.php'))
		{
		...
		{
			// if (!defined('PHPFOX_SCRIPT_CONFIG')) {
				define('PHPFOX_SCRIPT_CONFIG', true);
			// }
		}
		...
		if (defined('PHPFOX_INSTALLER')) {
			...
			if (isset($this->_aParams['db']) && isset($this->_aParams['db']['driver']) && ($this->_aParams['db']['driver'] == 'mysqli') && !function_exists('mysqli_connect')) {
