...
class Phpfox_Debug
{
	...
	{		
    	...
    	{    	
    		$sDebugReturn .= '<div style="font-size:9pt; text-align:center;">Page generated in ' . round($iTotalTime, 4) . ' seconds with ' . $iSqlCount . ' queries and GZIP ' . (Phpfox::getParam('core.use_gzip') ? 'enabled' : 'disabled') . ' on ' . $_SERVER['SERVER_ADDR'] . '.</div>';
    	}    	
