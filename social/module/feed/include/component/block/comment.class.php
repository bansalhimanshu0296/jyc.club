...
class Feed_Component_Block_Comment extends Phpfox_Component 
{
	...
	public function process()
	{
		...
		$aFeed['likes'] = Phpfox::getService('like')->getLikesForFeed($aFeed['like_type_id'], $aFeed['item_id'], false, Phpfox::getParam('feed.total_likes_to_display'));
		...
		if (Phpfox::isModule('like') && ((isset($aFeed['total_like']) && $aFeed['total_like'] > 0 && Phpfox::getParam('like.show_user_photos') == false) ||
				...
				(Phpfox::getParam('like.allow_dislike') && Phpfox::isModule('like'))
			))
		{
