...
class Feed_Component_Block_Display extends Phpfox_Component 
{
	...
	public function process()
	{
		...
		if ($this->request()->get('custom_app') && Phpfox::isApp($this->request()->get('custom_app')) && !defined('PHPFOX_IS_APP_STREAM')) {
			define('PHPFOX_IS_APP_STREAM', $this->request()->get('custom_app'));
		}
		...
		*/
		...
		$this->template()->assign(array(
				...
				'sCustomApp' => (defined('PHPFOX_IS_APP_STREAM') ? PHPFOX_IS_APP_STREAM : '')
			)
		);	
