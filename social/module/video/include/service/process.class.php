	...
	public function delete($iId = null, &$aVideo = null)
	{
		...
		{		
			...
			if (Phpfox::getParam('core.allow_cdn'))
			{
				...
				{
					Phpfox::getLib('cdn')->remove(Phpfox::getParam('video.dir') . sprintf(str_replace('flv', 'mp4', $aVideo['destination']), ''));
					Phpfox::getLib('cdn')->remove(Phpfox::getParam('video.dir') . sprintf(str_replace('flv', 'ogg', $aVideo['destination']), ''));
					Phpfox::getLib('cdn')->remove(Phpfox::getParam('video.dir') . sprintf(str_replace('flv', 'webm', $aVideo['destination']), ''));
				}
			}
