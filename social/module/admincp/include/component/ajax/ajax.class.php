...
{
	public function updateMenuActive() {
		Phpfox::isAdmin(true);

		Phpfox::getService('admincp.menu.process')->isActive($this->get('id'), $this->get('active'));
	}

	public function updateMenuOrder() {
		Phpfox::isAdmin(true);

		Phpfox::getService('admincp.menu.process')->updateOrder($this->get('ordering'));
	}
	...
	public function processOrdering() {
		...
		$new_id = Phpfox::getService('admincp.block.process')->processOrdering($this->get('blocks'));
	...
	public function getBlocks()
	{
		...
		$this->call('Core.admincp.show_frame(\'' . Phpfox::getLib('url')->makeUrl('core.sample') . 'inadmindesignmode_' . $this->get('m_connection') . '/\');');
		/*
	...
	public function getBlockContent() {
		$block = Phpfox::getService('admincp.block')->getForEdit($this->get('id'));
	...
	public function manageBlock() {
		...
		// Phpfox::getBlock('admincp.block.create');
		echo Phpfox::getService('admincp.block.process')->processCustomBlock(array(
			'html' => $this->get('html'),
	...
	public function updateBlockName() {
		...
		Phpfox::getService('admincp.block.process')->updateName($this->get('block_id'), $this->get('name'));
	}
	...
	public function deleteBlock() {
		...
		Phpfox::getService('admincp.block.process')->delete($this->get('block_id'));
	}
