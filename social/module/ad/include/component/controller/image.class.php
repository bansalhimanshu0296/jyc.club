...
class Ad_Component_Controller_Image extends Phpfox_Component
{
	...
	public function process()
	{
		...
		{
			Phpfox::getLib('image')->createThumbnail(Phpfox::getParam('ad.dir_image') . sprintf($sFileName, ''), Phpfox::getParam('ad.dir_image') . sprintf($sFileName, '_thumb'), (Phpfox::getParam('ad.multi_ad') ? 75 : ($aParts[0] / 3)), (Phpfox::getParam('ad.multi_ad') ? 75 : ($aParts[1] - 20)), false);
