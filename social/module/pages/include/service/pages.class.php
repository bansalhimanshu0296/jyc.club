...
class Pages_Service_Pages extends Phpfox_Service 
{
	...
	public function getMyAdminPages($iLimit = 0)
	{
		...
		{				
				...
				$aRows = $this->database()->select('pages.*, pu.vanity_url, u.server_id AS profile_server_id, u.user_image AS profile_user_image, ' . Phpfox::getUserField())
					->unionFrom('pages')
