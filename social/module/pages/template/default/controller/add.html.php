			...
			<div class="pages_type_add_form_holder">
				<form method="post" action="#">
					...
					<div class="pages_type_add_form_input">
						<select name="val[category_id]" class="page_category_select">
					...
					{/if}
					<div class="pages_2nd_step">
						<div class="pages_type_add_form_input">
							<input type="text" name="val[title]" value="" class="pages_type_add_input" />
						</div>
						<div class="pages_type_add_form_input pages_type_add_form_submit">
