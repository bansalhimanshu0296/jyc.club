...
<form action="{url link="current"}" method="post" id="frm_announcement">
	...
	<div id="admincp_search_content">
		...
		<div class="table">
			<div class="table_left">
				{phrase var='announcement.subject'} {$aLanguage.title}:
			</div>
		...
		<div class="table">
			<div class="table_left">
				{phrase var='announcement.intro'} {$aLanguage.title}:
			</div>
			<div class="table_right">
		...
		<div class="table">
			<div class="table_left">
				{required}{phrase var='announcement.announcement'} {$aLanguage.title}:
			</div>
			<div class="table_right">
		...
		<div class="table_clear table_clear_first">
	...
	<div id="admincp_search_panel">
		...
		<div class="table_clear table_clear_second">
			<input type="submit" value="{phrase var='core.submit'}" class="button" />
		</div>
	</div>
