...
?>
	<div class="profile_timeline_header_holder">
		<div {if (!empty($aCoverPhoto.destination))}data-url="{img id='js_photo_cover_position' server_id=$aCoverPhoto.server_id path='photo.url_photo' file=$aCoverPhoto.destination suffix='_1024' return_url=true}"{/if} class="profile_header">
