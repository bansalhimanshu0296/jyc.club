...
{	
	...
	public function add($aVals, $iUserGroupId = null)
	{
		...
		if (!defined('PHPFOX_INSTALLER') && !Phpfox::getParam('user.profile_use_id') && !Phpfox::getParam('user.disable_username_on_sign_up'))
		{
		...
		*/
		...
		if (Phpfox::getParam('user.profile_use_id') || Phpfox::getParam('user.disable_username_on_sign_up') || defined('PHPFOX_INSTALLER'))
		{
