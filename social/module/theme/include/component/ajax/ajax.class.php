...
class Theme_Component_Ajax_Ajax extends Phpfox_Ajax
{
	...
	public function saveJsFile() {
		if (Phpfox::getService('theme.style.process')->updateJs($this->get('val'))) {
	...
	public function deleteTheme() {
		Phpfox::isAdmin(true);
		Phpfox::getService('theme.process')->delete($this->get('id'));
		echo 'window.location.href = \'' . Phpfox::getLib('url')->makeUrl('admincp.theme') . '\';';
	}

	public function setDefault() {
		Phpfox::isAdmin(true);
		Phpfox::getService('theme.process')->setDefault($this->get('id'));
	}

	public function installTheme() {
		Phpfox::isAdmin(true);

		Phpfox::getBlock('theme.install');
	}
}
