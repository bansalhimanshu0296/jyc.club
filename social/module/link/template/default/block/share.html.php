...
?>
				<div class="global_attachment_holder_section" id="global_attachment_link">	
					<div class="js_preview_content_holder_action" id="global_attachment_link_holder">
						<div>
							<span class="js_attach_holder"><input type="text" name="val[link][url]" value="http://" id="js_global_attach_value" onfocus="if (this.value == 'http://') {l} this.value = ''; {r}" onblur="if (this.value == '') {l} this.value = 'http://' {r}" class="global_link_input" /></span>
							<input type="button" value="{phrase var='link.attach'}" id="js_global_attach_link" class="button global_link_input_button" />
						</div>			
