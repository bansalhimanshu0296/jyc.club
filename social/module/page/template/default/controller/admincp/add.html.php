...
?>
{$sCreateJs}
<form class="form_panel_holder" method="post" action="{url link='admincp.page.add'}" id="js_form" onsubmit="{$sGetJsForm}">
	...
	<div id="aceeditor" data-id="text">{value type='input' id='text'}</div>
