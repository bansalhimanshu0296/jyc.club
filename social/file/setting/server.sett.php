...
$_CONF['db']['user'] = 'juitpw8t_social';
$_CONF['db']['pass'] = 'social';
$_CONF['db']['name'] = 'juitpw8t_social';
$_CONF['db']['prefix'] = 'db_';
$_CONF['db']['port'] = '';
...
$_CONF['core.host'] = 'jyc.club';

$_CONF['core.folder'] = '/social/';

$_CONF['core.url_rewrite'] = '2';

$_CONF['core.salt'] = '4a66275819ef495ca8f53fd69ba06a18';
