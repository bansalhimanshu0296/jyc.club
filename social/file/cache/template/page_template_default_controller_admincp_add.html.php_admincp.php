...
<form class="form_panel_holder" method="post" action="<?php echo Phpfox::getLib('phpfox.url')->makeUrl('admincp.page.add'); ?>" id="js_form" onsubmit="<?php echo $this->_aVars['sGetJsForm']; ?>">
...
<?php Phpfox::getBlock('help.popup', array('phrase' => 'admincp.page_add_access')); ?>
	...
	<div id="aceeditor" data-id="text"><?php $aParams = (isset($aParams) ? $aParams : Phpfox::getLib('phpfox.request')->getArray('val')); echo (isset($aParams['text']) ? Phpfox::getLib('phpfox.parse.output')->clean($aParams['text']) : (isset($this->_aVars['aForms']['text']) ? Phpfox::getLib('phpfox.parse.output')->clean($this->_aVars['aForms']['text']) : '')); ?>
</div>
