...
<?php echo '<span class="user_profile_link_span" id="js_user_name_link_' . $this->_aVars['aFriend']['user_name'] . '"><a href="' . Phpfox::getLib('phpfox.url')->makeUrl('profile', array($this->_aVars['aFriend']['user_name'], ((empty($this->_aVars['aFriend']['user_name']) && isset($this->_aVars['aFriend']['profile_page_id'])) ? $this->_aVars['aFriend']['profile_page_id'] : null))) . '">' . Phpfox::getLib('phpfox.parse.output')->shorten(Phpfox::getService('user')->getCurrentName($this->_aVars['aFriend']['user_id'], $this->_aVars['aFriend']['full_name']), 40, '...') . '</a></span>'; ?>
	</li>
<?php endforeach; endif; ?>
</ul>
<div class="clear"></div>
...
<?php if (count((array)$this->_aVars['aLists']['friends'])):  foreach ((array) $this->_aVars['aLists']['friends'] as $this->_aVars['aList']): ?>
		<li>
<?php echo Phpfox::getLib('phpfox.image.helper')->display(array('user' => $this->_aVars['aList'],'suffix' => '_100_square','max_width' => 100,'max_height' => 100)); ?>
<?php echo Phpfox::getLib('phpfox.parse.output')->shorten('<span class="user_profile_link_span" id="js_user_name_link_' . $this->_aVars['aList']['user_name'] . '" itemprop="author"><a href="' . Phpfox::getLib('phpfox.url')->makeUrl('profile', array($this->_aVars['aList']['user_name'], ((empty($this->_aVars['aList']['user_name']) && isset($this->_aVars['aList']['profile_page_id'])) ? $this->_aVars['aList']['profile_page_id'] : null))) . '" rel="author" >' . Phpfox::getLib('phpfox.parse.output')->shorten(Phpfox::getLib('phpfox.parse.output')->split(Phpfox::getService('user')->getCurrentName($this->_aVars['aList']['user_id'], $this->_aVars['aList']['full_name']), 12, true), Phpfox::getParam('user.maximum_length_for_full_name')) . '</a></span>', 40, '...'); ?>
		</li>	
<?php endforeach; endif; ?>
		</ul>
		<div class="clear"></div>
