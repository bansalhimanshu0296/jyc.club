...
<?php echo Phpfox::getPhrase('friend.add_a_personal_message'); ?>
			</a>
		</div>
		<div id="js_personal_message" style="display:none;">
<?php echo Phpfox::getPhrase('friend.add_a_personal_message_form'); ?>: <a href="#" onclick="$('#js_personal_message').hide(); $('#js_personal_link').show(); return false;">
<?php echo Phpfox::getPhrase('friend.cancel'); ?>
			</a>
			<div>
