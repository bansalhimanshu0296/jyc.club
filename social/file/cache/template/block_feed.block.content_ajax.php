...
<?php endif; ?>
			<div class="<?php if (( ! empty ( $this->_aVars['aFeed']['feed_content'] ) || ! empty ( $this->_aVars['aFeed']['feed_custom_html'] ) ) && empty ( $this->_aVars['aFeed']['feed_image'] )): ?> activity_feed_content_no_image<?php endif;  if (! empty ( $this->_aVars['aFeed']['feed_image'] )): ?> activity_feed_content_float<?php endif; ?>">
...
<?php if (strpos ( $this->_aVars['aFeed']['feed_content'] , '<br />' ) >= 200): ?>
...
<?php else: ?>
<?php echo Phpfox::getLib('phpfox.parse.output')->shorten(Phpfox::getLib('parse.output')->maxLine(Phpfox::getLib('phpfox.parse.output')->split(Phpfox::getLib('parse.output')->feedStrip($this->_aVars['aFeed']['feed_content']), 55)), 200, '...'); ?>
<?php endif; ?>
					</div>
<?php endif; ?>
