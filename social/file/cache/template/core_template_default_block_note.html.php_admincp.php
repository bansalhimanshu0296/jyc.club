...
<?php echo Phpfox::getLib('phpfox.image.helper')->display(array('theme' => 'ajax/small.gif')); ?>
	...
	<textarea id="js_admincp_note" name="admincp_note" cols="60" rows="8" onblur="$('#js_share_user_status').hide(); $('#js_save_note').show(); $('#js_admincp_note').ajaxCall('core.admincp.updateNote');" placeholder="Save your notes here..."><?php echo $this->_aVars['sAdminNote']; ?></textarea>
</div>
