...
<?php echo '<div><input type="hidden" name="' . Phpfox::getTokenName() . '[security_token]" value="' . Phpfox::getService('log.session')->getToken() . '" /></div>'; ?>
					...
					<div class="header_bar_search_holder">
						...
						<input type="text" class="txt_input<?php if (isset ( $this->_aVars['aSearchTool']['search']['actual_value'] )): ?> input_focus<?php endif; ?>" name="search[<?php echo $this->_aVars['aSearchTool']['search']['name']; ?>]" placeholder="<?php echo $this->_aVars['aSearchTool']['search']['default_value']; ?>" value="<?php if (isset ( $this->_aVars['aSearchTool']['search']['actual_value'] )):  echo Phpfox::getLib('phpfox.parse.output')->clean($this->_aVars['aSearchTool']['search']['actual_value']);  endif; ?>" />
