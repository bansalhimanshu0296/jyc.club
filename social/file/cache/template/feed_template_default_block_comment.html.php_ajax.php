...
<div id="js_feed_like_holder_<?php echo $this->_aVars['aFeed']['type_id']; ?>_<?php echo $this->_aVars['aFeed']['item_id']; ?>" class="comment_mini_content_holder">
        <div class="comment_mini_content_holder_icon"></div>
			<div class="comment_mini_content_border">

				<div class="activity_action_bar <?php if (Phpfox ::isUser() && Phpfox ::isModule('like') && isset ( $this->_aVars['aFeed']['feed_is_liked'] ) && $this->_aVars['aFeed']['feed_is_liked']): ?> is_liked<?php endif; ?>">
...
<?php if (isset ( $this->_aVars['aFeed']['like_item_id'] )): ?>
					<ul><?php Phpfox::getBlock('like.link', array('like_type_id' => $this->_aVars['aFeed']['like_type_id'],'like_item_id' => $this->_aVars['aFeed']['like_item_id'],'like_is_liked' => $this->_aVars['aFeed']['feed_is_liked'])); ?></ul>
<?php else: ?>
					<ul><?php Phpfox::getBlock('like.link', array('like_type_id' => $this->_aVars['aFeed']['like_type_id'],'like_item_id' => $this->_aVars['aFeed']['item_id'],'like_is_liked' => $this->_aVars['aFeed']['feed_is_liked'])); ?></ul>
<?php endif; ?>
...
<?php endif; ?>
					<div class="<?php if (isset ( $this->_aVars['sFeedType'] ) && $this->_aVars['sFeedType'] == 'view'): ?>comment_mini_content <?php endif; ?>comment_mini_textarea_holder">
						...
						<div class="js_feed_comment_process_form"><?php echo Phpfox::getLib('phpfox.image.helper')->display(array('theme' => 'ajax/add.gif')); ?></div>
					</div>
...
<div class="report_this_item">
	<a href="<?php echo Phpfox::getLib('phpfox.url')->makeUrl(''); ?>#?call=report.add&amp;height=100&amp;width=400&amp;type=<?php echo $this->_aVars['aFeed']['report_module']; ?>&amp;id=<?php echo $this->_aVars['aFeed']['item_id']; ?>" class="item_bar_flag inlinePopup" title="<?php echo $this->_aVars['aFeed']['report_phrase']; ?>"><?php echo $this->_aVars['aFeed']['report_phrase']; ?></a>
</div>
