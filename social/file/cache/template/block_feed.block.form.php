...
<?php if (isset ( $this->_aVars['aFeedCallback']['module'] )): ?>
						<li><a href="#" rel="global_attachment_status" class="active"><div><?php echo Phpfox::getPhrase('feed.post'); ?><span class="activity_feed_link_form_ajax"><?php echo $this->_aVars['aFeedCallback']['ajax_request']; ?></span></div><div class="drop"></div></a></li>
<?php elseif (! isset ( $this->_aVars['bFeedIsParentItem'] ) && ( ! defined ( 'PHPFOX_IS_USER_PROFILE' ) || ( defined ( 'PHPFOX_IS_USER_PROFILE' ) && isset ( $this->_aVars['aUser']['user_id'] ) && $this->_aVars['aUser']['user_id'] == Phpfox ::getUserId()))): ?>
						<li><a href="#" rel="global_attachment_status" class="active"><div><?php echo Phpfox::getPhrase('feed.status'); ?><span class="activity_feed_link_form_ajax">user.updateStatus</span></div><div class="drop"></div></a></li>
<?php else: ?>
						<li><a href="#" rel="global_attachment_status" class="active"><div><?php echo Phpfox::getPhrase('feed.post'); ?><span class="activity_feed_link_form_ajax">feed.addComment</span></div><div class="drop"></div></a></li>
<?php endif; ?>
