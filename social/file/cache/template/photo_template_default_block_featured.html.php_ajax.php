...
?>
<div class="t_center">
	<a href="<?php echo Phpfox::permalink('photo', $this->_aVars['aFeaturedImage']['photo_id'], $this->_aVars['aFeaturedImage']['title'], false, null, (array) array (
)); ?>">
<?php if (( Phpfox ::getLib('template')->getStyleFolder() == 'nebula' )): ?>
<?php echo Phpfox::getLib('phpfox.image.helper')->display(array('server_id' => $this->_aVars['aFeaturedImage']['server_id'],'path' => 'photo.url_photo','file' => $this->_aVars['aFeaturedImage']['destination'],'suffix' => '_240','max_width' => 170,'max_height' => 240)); ?>
<?php else: ?>
<?php echo Phpfox::getLib('phpfox.image.helper')->display(array('server_id' => $this->_aVars['aFeaturedImage']['server_id'],'path' => 'photo.url_photo','file' => $this->_aVars['aFeaturedImage']['destination'],'suffix' => '_240','max_width' => 240,'max_height' => 240)); ?>
<?php endif; ?>
	</a>
</div>
<?php if (Phpfox ::getParam('photo.ajax_refresh_on_featured_photos')): ?>
<script type="text/javascript">
	setTimeout("$.ajaxCall('photo.refreshFeaturedImage', '', 'GET');", <?php echo $this->_aVars['iRefreshTime']; ?>);
</script>
<?php endif; ?>
