...
" placeholder="<?php echo Phpfox::getPhrase('user.full_name'); ?>" size="30" />
			</div>			
		</div>
<?php endif; ?>
...
" placeholder="<?php echo Phpfox::getPhrase('user.email'); ?>" size="30" />
			</div>			
		</div>
<?php if (Phpfox ::getParam('user.reenter_email_on_signup')): ?>
		<div class="table">
...
<?php if (isset ( $this->_aVars['bIsPosted'] )): ?>
				<input type="password" name="val[password]" id="password" placeholder="<?php echo Phpfox::getPhrase('user.password'); ?>" value="<?php $aParams = (isset($aParams) ? $aParams : Phpfox::getLib('phpfox.request')->getArray('val')); echo (isset($aParams['password']) ? Phpfox::getLib('phpfox.parse.output')->clean($aParams['password']) : (isset($this->_aVars['aForms']['password']) ? Phpfox::getLib('phpfox.parse.output')->clean($this->_aVars['aForms']['password']) : '')); ?>
" size="30" />
<?php else: ?>
				<input type="password" name="val[password]" id="password" placeholder="<?php echo Phpfox::getPhrase('user.password'); ?>" value="" size="30" />
<?php endif; ?>
			</div>			
		</div>
