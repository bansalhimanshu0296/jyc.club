...
<?php endif; ?>
					...
					<div class="table_clear">
<?php if (isset ( $this->_aVars['bIsPosted'] ) || ! Phpfox ::getParam('user.multi_step_registration_form')): ?>
						<input type="submit" value="<?php echo Phpfox::getPhrase('user.sign_up'); ?>" class="button" id="js_registration_submit" />
<?php else: ?>
						<input type="button" value="<?php echo Phpfox::getPhrase('user.sign_up'); ?>" class="button" id="js_registration_submit" onclick="$Core.registration.submitForm();" />
<?php endif; ?>
					</div>
