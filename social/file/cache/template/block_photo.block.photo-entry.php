...
<div class="photo_clip_holder_border<?php if (Phpfox ::getParam('photo.show_info_on_mouseover')): ?>_big<?php endif; ?>">
	<a href="<?php echo $this->_aVars['aPhoto']['link'];  if (isset ( $this->_aVars['iForceAlbumId'] )): ?>albumid_<?php echo $this->_aVars['iForceAlbumId']; ?>/<?php endif;  if (isset ( $this->_aVars['sPhotoCategory'] )): ?>category_<?php echo $this->_aVars['sPhotoCategory']; ?>/<?php endif; ?>"
