...
<?php /* Cached: March 18, 2015, 9:12 pm */ ?>
<?php 
/**
...
<div id="poke_<?php echo $this->_aVars['aUser']['user_id']; ?>_image" class="go_left">
<?php if (Phpfox ::isMobile()): ?>
<?php echo Phpfox::getLib('phpfox.image.helper')->display(array('user' => $this->_aVars['aUser'],'suffix' => '_50_square','max_width' => 50,'max_height' => 50,'class' => 'v_middle')); ?>
<?php else: ?>
<?php echo Phpfox::getLib('phpfox.image.helper')->display(array('user' => $this->_aVars['aUser'],'suffix' => '_120_square','max_width' => 120,'max_height' => 120,'class' => 'v_middle')); ?>
<?php endif; ?>
</div>
<div id="poke_<?php echo $this->_aVars['aUser']['user_id']; ?>_content">
<?php echo Phpfox::getPhrase('poke.you_are_about_to_poke_full_name', array('full_name' => $this->_aVars['aUser']['full_name'])); ?>
	<br />
	<br />
	<input type="button" class="button" onclick="$.ajaxCall('poke.doPoke', 'user_id=<?php echo $this->_aVars['aUser']['user_id']; ?>', 'GET');tb_remove();" value="<?php echo Phpfox::getPhrase('poke.poke', array('full_name' => '')); ?>">
</div>
<div class="clear"></div>
